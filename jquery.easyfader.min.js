...
c.effectDur)}else c.$slides.eq(b).animate({opacity:1},c.effectDur,function(){c.cleanUp(a,b)})},_changeSlides:function(a){"next"==a?(this.newSlide=1*this.activeSlide+1,this.newSlide>this.totalSlides-1&&(this.newSlide=0)):"prev"==a?(this.newSlide=1*this.activeSlide-1,0>this.newSlide&&(this.newSlide=this.totalSlides-1)):this.newSlide=a;this.animateSlides(this.activeSlide,this.newSlide)},waitForNext:function(){var a=this;a.slideTimer=setTimeout(function(){a._changeSlides("next")},a.slideDur)},getPrefixedCSS:function(a,
b,c){var e={};for(i=0;2>i;i++){var d=0==i?this.prefix:"";c?e[d+a]=d+b:e[d+a]=b}return e},pause:function(){clearTimeout(this.slideTimer);this.autoCycle=!1},resume:function(){this.autoCycle=this;this.waitForNext()},changeSlides:function(a){clearTimeout(this.slideTimer);this._changeSlides(a)}};d.fn.easyFader=function(){var a=arguments;return this.each(function(){if(a&&"string"===typeof a[0])EasyFader.prototype.instances[this.id][a[0]](a[1]);else{var b=a[0],c=new EasyFader;c.init(this,b);c.instances[this.id]=
c}})}})(jQuery);