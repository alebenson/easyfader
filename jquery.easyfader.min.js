...
(this.activeSlide=0);this.$pagers=this.$pagerList.find(".pager");this.$pagers.eq(this.activeSlide).addClass("active");this.fadeOnLoad?this.fadeSlides(this.activeSlide+1,0):this.autoCycle&&1<this.totalSlides&&this.waitForNext()},bindHandlers:function(){var a=this;a.$container.find(".pager").on("click",function(){var b=d(this).attr("data-target");clearTimeout(a.slideTimer);a.__changeSlides(b)});d(window).on("keydown",function(b){b=b.keyCode;if(39==b||37==b)b=39==b?"next":"prev",clearTimeout(a.slideTimer),
a.__changeSlides(b)})},cleanUp:function(a,b){if(this.firstLoad&&this.fadeOnLoad)this.fadeCleanUp(a,b);else this[this.effect+"CleanUp"](a,b);this.activeSlide=b;this.changing=!1;"function"==typeof this.onChangeEnd&&this.onChangeEnd.call(this,this.$slides.eq(this.activeSlide));this.firstLoad=!1;this.autoCycle&&this.waitForNext()},fadeCleanUp:function(a,b){this.$slides.eq(a).removeStyle("opacity, z-index");this.$slides.eq(b).removeStyle(this.prefix+"transition, transition")},animateSlides:function(a,
b){if(this.changing||a==b)return!1;this.changing=!0;this.$pagers.removeClass("active").eq(this.newSlide).addClass("active");"function"!=typeof this.onChangeStart||this.firstLoad||this.onChangeStart.call(this,this.$slides.eq(this.newSlide));this[this.effect+"Slides"](a,b)},fadeSlides:function(a,b){var c=this;c.$slides.eq(a).css("z-index",2);c.$slides.eq(b).css("z-index",3);if(c.prefix){var e={};e[c.prefix+"transition"]="opacity "+c.effectDur+"ms";e.opacity=1;c.$slides.eq(b).css(e);setTimeout(function(){c.cleanUp(a,
b)},c.effectDur)}else c.$slides.eq(b).animate({opacity:1},c.effectDur,function(){c.cleanUp(a,b)})},__changeSlides:function(a){"next"==a?(this.newSlide=this.activeSlide+1,this.newSlide>this.totalSlides-1&&(this.newSlide=0)):"prev"==a?(this.newSlide=this.activeSlide-1,0>this.newSlide&&(this.newSlide=this.totalSlides-1)):this.newSlide=a;this.animateSlides(this.activeSlide,this.newSlide)},waitForNext:function(){var a=this;a.slideTimer=setTimeout(function(){a.__changeSlides("next")},a.slideDur)},getPrefixedCSS:function(a,
b,c){var e={};for(i=0;2>i;i++){var d=0==i?this.prefix:"";c?e[d+a]=d+b:e[d+a]=b}return e},pause:function(){clearTimeout(this.slideTimer);this.autoCycle=!1},resume:function(){this.autoCycle=this;this.waitForNext()},changeSlides:function(a){clearTimeout(this.slideTimer);this.__changeSlides(a)}};d.fn.easyFader=function(){var a=arguments;return this.each(function(){if(a&&"string"===typeof a[0])EasyFader.prototype.instances[this.id][a[0]](a[1]);else{var b=a[0],c=new EasyFader;c.init(this,b);c.instances[this.id]=
c}})}})(jQuery);