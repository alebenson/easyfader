...
a.prefix+"transform")&&!e&&(e=!0,a.cleanUp(c,d))});setTimeout(function(){b.css(a.getPrefixedCSS("transform","translate3d("+g+",0,0)"));f.css(a.getPrefixedCSS("transform","translate3d(0,0,0)"))},10)};f.css({opacity:1,zIndex:3}).css(a.getPrefixedCSS("transform","translate3d("+e+",0,0)"));setTimeout(function(){k()},10)}else f.css({left:e,opacity:1,zIndex:3}).animate({left:0},a.effectDur),b.animate({left:g},a.effectDur,function(){a.cleanUp(c,d)})},slideCleanUp:function(c,d){var a=this.$slides.eq(c),b=
